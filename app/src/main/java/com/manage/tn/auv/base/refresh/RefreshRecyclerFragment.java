package com.manage.tn.auv.base.refresh;
...
import com.manage.tn.auv.databinding.FragmentRefreshRecyclerBinding;
import com.manage.tn.auv.util.fastcolck.SingleClick;
...
public abstract class RefreshRecyclerFragment extends
    ...
    * */
    public  void afterReturnDataForUi(String uuid,BaseResponse event) {
        ...
        if(null!=postType){
            if(event.getStatus_code()== Constant.SUCCESS){
